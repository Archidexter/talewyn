...
function applySettings() {
  ...
  // иконка приложения под тему. Дёргаем ТОЛЬКО при реальной смене: лаунчер пересоздаёт
  // ярлык, и лишние переключения зря им трясут. Мост есть не во всех сборках — guard.
  try {
...
const OVERLAY_SEL = '#scan-modal, #confirm-modal, #settings-sheet, #note-sheet, #tr-sheet, #review-sheet, '
  + '#ab-notes-sheet, #annot-sheet, #info-sheet, #pronun-sheet, #col-create, #col-pick, #sync-pick, #lightbox, #word-pop';
