...
const CACHE = 'talewyn-v352';
const SHELL = [
  './', './index.html', './app.css?v=277', './app.js?v=345', './genres.js?v=1',
  './importers.js?v=25', './edge-tts.js?v=1', './jsmediatags.min.js?v=1', './fonts.css?v=9',
  './catalog.js?v=4', './grab.js?v=2', './fflate.js',
